...
/*  const deleteInterview = useCallback(() => {
  ...
  return (
    <CTableRow style={{backgroundColor:"white"}} className="table-row" v-for="item in tableItems">
      ...
      <CTableDataCell>{interview.dateTime}</CTableDataCell>
      <CTableDataCell className="text-center">Candidate Name</CTableDataCell>
      <CTableDataCell className="text-center">Manager Name</CTableDataCell>
